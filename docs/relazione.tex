...
E' possibile che, durante l'esecuzione del programma, possa apparire questo
messaggio di errore: \\
...
\noindent Questo errore è dovuto ad una versione datata della
libreria \texttt{frozendict} usata come dipendenza della libreria \texttt{experta}. \\
Fare l'upgrade della libreria \texttt{frozendict} alla versione più recente, andrebbe a
